...
export default function ModernFlashcard({ flashcards, currentIndex, onNext, onPrevious, onComplete }: ModernFlashcardProps) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 space-y-6" data-testid="modern-flashcard-container">
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center gap-3">
                ...
                <Button
                  ...
                  className="bg-yellow-500 hover:bg-yellow-600 text-white min-w-[100px]"
